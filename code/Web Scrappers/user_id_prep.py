...
with open('/Users/apple/Desktop/YELP_REVIEWS/code/data/ready_data/naperville/Sentiment Analysis/naperville_reviews_data_part2_dict_sentiment_Data.csv',encoding='ISO-8859-1') as readfile:
...
with open('/Users/apple/Desktop/YELP_REVIEWS/code/data/user_data_to_scrape/user_ids_naperville_part2.csv', 'w',encoding='ISO-8859-1',newline='') as csvwriterfile:
