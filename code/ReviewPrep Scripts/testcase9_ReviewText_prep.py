###TESTCASE 9 : OLD ELITE USER NEGATIVE RATING
##PICK older 1-2 star rating Elite user review from same business
#Repost review
...
with open('//Users//apple//Desktop//YELP_REVIEWS//code//data//ready_data//CHICAGO_part1.csv', 'r',encoding='utf8',newline='') as csvreaderfile:
    ...
    review_rating=''
    for row in reader:
        if((row['star_rating'] == '1' or row['star_rating'] == '2') and row['elite_status'] == '1'):  ##considering reviews of rating 5 star elite user only
...
with open('testcase9_ChicagoPart1_ReviewText_Data.csv', 'w',encoding='utf8',newline='') as csvwriterfile:
